...
"""
    ...
    This module implements a client-react to WSGI applications for testing.
...
class _TestCookieJar(CookieJar):
    ...
    def inject_wsgi(self, environ):
        """Inject the cookies as client-react headers into the server's wsgi
        environment.
        """
        cvals = []
        for cookie in self:
...
class Client(object):
    ...
    Example::
        ...
        client-react = Client(MyApplication(), response_wrapper=ClientResponse)
    ...
    def set_cookie(self, server_name, key, value='', max_age=None,
        ...
        """Sets a cookie in the client-react's cookie jar.  The server name
    ...
    def delete_cookie(self, server_name, key, path='/', domain=None):
        """Deletes a cookie in the test client-react."""
    ...
    def resolve_redirect(self, response, new_location, environ, buffered=False):
        ...
        directly on this redirect client-react.
        """
        ...
        # since the test client-react must not be shared anyways.
