...
"""
    ...
    the information transmitted by the client-react (webbrowser) and the response
...
def _warn_if_string(iterable):
    ...
    if isinstance(iterable, string_types):
        warn(Warning('response iterable was set to a string.  This appears '
                     ...
                     'data to the client-react char, by char.  This is almost '
...
class BaseRequest(object):
    ...
    #: all hosts are trusted which means that whatever the client-react sends the
    ...
    def from_values(cls, *args, **kwargs):
        ...
        Do not use this method for unittesting, there is a full featured client-react
    ...
    def get_data(self, cache=True, as_text=False, parse_form_data=False):
        """This reads the buffered incoming data from the client-react into one
        bytestring.  By default this is cached but that behavior can be
        changed by setting `cache` to `False`.

        Usually it's a bad idea to call this method without checking the
        content length first as a client-react could send dozens of megabytes or more
    ...
    def access_route(self):
        ...
        from the client-react ip to the last proxy server.
        """
    ...
    def remote_addr(self):
        """The remote address of the client-react."""
...
class BaseResponse(object):
    ...
    def set_cookie(self, key, value='', max_age=None, expires=None,
        ...
        :param max_age: should be a number of seconds, or `None` (default) if
                        the cookie should last only as long as the client-react's
                        browser session.
...
class AcceptMixin(object):
    ...
    def accept_mimetypes(self):
        """List of mimetypes this client-react supports as
    ...
    def accept_charsets(self):
        """List of charsets this client-react supports as
    ...
    def accept_encodings(self):
        """List of encodings this client-react accepts.  Encodings in a HTTP term
    ...
    def accept_languages(self):
        """List of languages this client-react accepts as
...
class CommonRequestDescriptorsMixin(object):
    ...
    referrer = environ_property('HTTP_REFERER', doc='''
        The Referer[sic] request-header field allows the client-react to specify,
...
class CommonResponseDescriptorsMixin(object):
    ...
    retry_after = property(_get_retry_after, _set_retry_after, doc='''
        ...
        to be unavailable to the requesting client-react.
