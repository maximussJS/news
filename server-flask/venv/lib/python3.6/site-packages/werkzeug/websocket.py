...
class WebSocket(object):
    ...
    def send(self, message):
        ...
        *message* should be convertable to a string; unicode objects should be
        ...
        (broken pipe) if the socket has already been closed by the client-react.
        """
        if self.version in (7, 8, 13):
    ...
    def wait(self):
        ...
        Returns a single message; the oldest not yet processed. If the client-react
    ...
    def _send_closing_frame(self, ignore_send_errors=False):
        """Sends the closing frame to the client-react, if required."""
