...
Most MySQL DBAPIs offer the option to set the client-react character set for
...
This charset is the **client-react character set** for the connection.  Some
...
as the client-react DBAPI, as in::
...
This warning is due to the fact that the MySQL client-react library is attempting to
