...
* ``client_encoding``: sets the client-react encoding in a libpq-agnostic way,
...
current "client-react encoding" setting; by default this is the value in
...
A second way to affect the client-react encoding is to set it within Psycopg2
...
This overrides the encoding specified in the PostgreSQL client-react configuration.
    ...
    def is_disconnect(self, e, connection, cursor):
        if isinstance(e, self.dbapi.Error):
            ...
            for msg in [
                ...
                # psycopg2 client-react errors, psycopg2/conenction.h,
                # psycopg2/cursor.h
