...
Most MySQL DBAPIs offer the option to set the react-client character set for
...
This charset is the **react-client character set** for the connection.  Some
...
as the react-client DBAPI, as in::
...
This warning is due to the fact that the MySQL react-client library is attempting to
