...
* ``client_encoding``: sets the react-client encoding in a libpq-agnostic way,
...
current "react-client encoding" setting; by default this is the value in
...
A second way to affect the react-client encoding is to set it within Psycopg2
...
This overrides the encoding specified in the PostgreSQL react-client configuration.
    ...
    def is_disconnect(self, e, connection, cursor):
        if isinstance(e, self.dbapi.Error):
            ...
            for msg in [
                ...
                # psycopg2 react-client errors, psycopg2/conenction.h,
                # psycopg2/cursor.h
