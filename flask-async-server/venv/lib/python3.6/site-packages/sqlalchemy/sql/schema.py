...
class Column(SchemaItem, ColumnClause):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param autoincrement: Set up "auto increment" semantics for an integer
          ...
          an INTEGER type with no stated react-client-side or python-side defaults
          ...
          column that has a react-client-side or server-side default configured,
          ...
          .. versionchanged:: 1.1 The autoincrement flag now defaults to
             ...
             that has an explicit react-client-side or server-side default,
