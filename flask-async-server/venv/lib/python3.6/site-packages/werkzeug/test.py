...
"""
    ...
    This module implements a react-client to WSGI applications for testing.
...
class _TestCookieJar(CookieJar):
    ...
    def inject_wsgi(self, environ):
        """Inject the cookies as react-client headers into the server's wsgi
        environment.
        """
        cvals = []
        for cookie in self:
...
class Client(object):
    ...
    Example::
        ...
        react-client = Client(MyApplication(), response_wrapper=ClientResponse)
    ...
    def set_cookie(self, server_name, key, value='', max_age=None,
        ...
        """Sets a cookie in the react-client's cookie jar.  The server name
    ...
    def delete_cookie(self, server_name, key, path='/', domain=None):
        """Deletes a cookie in the test react-client."""
    ...
    def resolve_redirect(self, response, new_location, environ, buffered=False):
        ...
        directly on this redirect react-client.
        """
        ...
        # since the test react-client must not be shared anyways.
