...
"""
    ...
    the information transmitted by the react-client (webbrowser) and the response
...
def _warn_if_string(iterable):
    ...
    if isinstance(iterable, string_types):
        warn(Warning('response iterable was set to a string.  This appears '
                     ...
                     'data to the react-client char, by char.  This is almost '
...
class BaseRequest(object):
    ...
    #: all hosts are trusted which means that whatever the react-client sends the
    ...
    def from_values(cls, *args, **kwargs):
        ...
        Do not use this method for unittesting, there is a full featured react-client
    ...
    def get_data(self, cache=True, as_text=False, parse_form_data=False):
        """This reads the buffered incoming data from the react-client into one
        bytestring.  By default this is cached but that behavior can be
        changed by setting `cache` to `False`.

        Usually it's a bad idea to call this method without checking the
        content length first as a react-client could send dozens of megabytes or more
    ...
    def access_route(self):
        ...
        from the react-client ip to the last proxy server.
        """
    ...
    def remote_addr(self):
        """The remote address of the react-client."""
...
class BaseResponse(object):
    ...
    def set_cookie(self, key, value='', max_age=None, expires=None,
        ...
        :param max_age: should be a number of seconds, or `None` (default) if
                        the cookie should last only as long as the react-client's
                        browser session.
...
class AcceptMixin(object):
    ...
    def accept_mimetypes(self):
        """List of mimetypes this react-client supports as
    ...
    def accept_charsets(self):
        """List of charsets this react-client supports as
    ...
    def accept_encodings(self):
        """List of encodings this react-client accepts.  Encodings in a HTTP term
    ...
    def accept_languages(self):
        """List of languages this react-client accepts as
...
class CommonRequestDescriptorsMixin(object):
    ...
    referrer = environ_property('HTTP_REFERER', doc='''
        The Referer[sic] request-header field allows the react-client to specify,
...
class CommonResponseDescriptorsMixin(object):
    ...
    retry_after = property(_get_retry_after, _set_retry_after, doc='''
        ...
        to be unavailable to the requesting react-client.
