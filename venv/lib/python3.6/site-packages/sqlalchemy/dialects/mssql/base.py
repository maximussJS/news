    ...
    def get_isolation_level(self, connection):
        ...
        for view in views:
            ...
            util.warn(
                ...
                "tried auth: %s; final error was: %s" % (views, last_error))
    ...
    def get_view_definition(self, connection, viewname,
        ...
        rp = connection.execute(
            sql.text(
                ...
                "sys.schemas as sch"
                " where "
                "mod.object_id=auth.object_id and "
                "auth.schema_id=sch.schema_id and "
                "auth.name=:viewname and sch.name=:schname",
                bindparams=[
